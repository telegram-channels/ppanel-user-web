                ...
                {paymentMethods?.map((item) => {
                  return (
                    <div key={item.mark}>
                      ...
                      <Label
                        htmlFor={item.mark}
                        className='flex flex-col items-center justify-between rounded-md border-2 border-muted bg-popover py-2 hover:bg-accent hover:text-accent-foreground peer-data-[state=checked]:border-primary'
                      >
